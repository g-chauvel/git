...
int cmd__delta_base_cache(int argc, const char **argv)
{
	...
	/*
	 * Reuse the same address, independent of the system allocator. Retarget
	 * first at the second pack, whose path has the same length, instead of
	 * copying the internal fields of struct packed_git.
	 */
